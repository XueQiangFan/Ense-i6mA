...
from I_DNAN6mAplus import selectedImportantFeatures
...
from I_DNAN6mAplus.runnClassifiers_averaging_voting_test22 import runClassifiers
...
def main(args):
    ...
    # selectedImportantFeatures.importantFeatures(X_train, Y_train)
